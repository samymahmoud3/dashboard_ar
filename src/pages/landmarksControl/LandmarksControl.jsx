...
import './landmarksControl.scss';

const LandmarksControl = () => {
  ...
  return (
    <div className="landmarks-control">
      <DataControl
        columns={ columns }
        rows={ rows }
        numbers={ 2 }
        navTitle="المزارات"
        title="تحكم فى المزارات"
        addNew_btn="اضافة مكان جديد "
        categories={ categories }
        setOpen={ setOpen }
      />
      { open &&
        <div className="modal">
          <h1>اضافة مكان جديد</h1>
